        ...
        <Routes>
          ...
          <Route path="/conciergerie-airbnb-tain-hermitage" element={
            <LocalLanding
              ...
              metaDescription="Conciergerie Airbnb à Tain-l'Hermitage : gestion locale de votre maison de campagne ou résidence secondaire, revenue management PriceLabs, ménage et check-in."
          ...
          <Route path="/gestion-location-courte-duree-drome-ardeche" element={
            <LocalLanding
              ...
              intro="Une gestion locale et pilotée pour vos maisons de campagne, appartements et résidences secondaires en Drôme-Ardèche : meilleure rentabilité, sans gestion quotidienne."
            />
          } />
          <Route path="/conciergerie-airbnb-drome" element={
            <LocalLanding
              ...
              metaDescription="Conciergerie Airbnb dans la Drôme : gestion locale de maisons de campagne et résidences secondaires, revenue management PriceLabs, ménage et check-in."
          ...
          <Route path="/conciergerie-airbnb-ardeche" element={
            <LocalLanding
              ...
              metaDescription="Conciergerie Airbnb en Ardèche : gestion de maisons de campagne et résidences secondaires en Ardèche verte, revenue management PriceLabs, ménage et check-in."
              h1="Conciergerie Airbnb en Ardèche"
              intro="Qit Concierge gère vos maisons de campagne et résidences secondaires en Ardèche — Tournon-sur-Rhône, Annonay, Ardèche verte, vallée du Rhône — avec optimisation Airbnb, Booking et Abritel, revenue management PriceLabs et accompagnement humain et terrain."
            />
          } />
          <Route path="/conciergerie-location-courte-duree-drome" element={
            <LocalLanding
              ...
              intro="Une conciergerie locale dédiée à la location courte durée dans la Drôme : maisons de campagne, appartements et résidences secondaires. Optimisation multi-plateformes, ménage, voyageurs et revenue management avec PriceLabs."
            />
          } />
          <Route path="/conciergerie-location-courte-duree-ardeche" element={
            <LocalLanding
              ...
              metaDescription="Conciergerie location courte durée en Ardèche : gestion de maisons de campagne en Ardèche verte, vallée du Rhône, ViaRhôna. Airbnb, Booking, Abritel + PriceLabs."
          ...
          <Route path="/gestion-gite-drome" element={
            <LocalLanding
              ...
              title="Gestion de maison dans la Drôme | Qit Concierge"
              metaDescription="Gestion de maisons de campagne dans la Drôme : conciergerie locale pour propriétaires non disponibles sur place, optimisation Airbnb / Booking / Abritel et tarification PriceLabs."
              h1="Gestion de maison dans la Drôme"
              intro="Vous possédez une maison de campagne dans la Drôme et vous n'êtes pas disponible sur place ? Qit Concierge prend en charge la gestion complète : annonces multi-plateformes, voyageurs, ménage, linge, check-in et revenue management PriceLabs."
            />
          } />
          <Route path="/gestion-gite-ardeche" element={
            <LocalLanding
              slug="gestion-gite-ardeche"
              title="Gestion de maison en Ardèche | Qit Concierge"
              metaDescription="Gestion de maisons de campagne en Ardèche : conciergerie locale pour propriétaires distants, optimisation Airbnb / Booking / Abritel et tarification dynamique PriceLabs."
              h1="Gestion de maison en Ardèche"
              intro="Confiez la gestion de votre maison de campagne en Ardèche — Ardèche verte, vallée du Rhône, vignobles — à une conciergerie locale : annonces, voyageurs, ménage, linge, check-in et revenue management PriceLabs."
            />
          } />
