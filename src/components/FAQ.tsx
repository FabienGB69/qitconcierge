...
const faqsFR = [
  ...
  { q: "Travaillez-vous uniquement avec des logements haut de gamme ?", a: "Non. Qit Concierge accompagne des biens adaptés à la location courte durée : maisons de campagne, [gîtes en Drôme](/gestion-gite-drome) et [gîtes en Ardèche](/gestion-gite-ardeche), appartements, [résidences secondaires](/conciergerie-residence-secondaire-drome-ardeche) et logements touristiques bien situés." },
  ...
  { q: "Est-ce que vous gérez les maisons et les gîtes ?", a: "Oui. Les maisons de campagne, [gîtes](/gestion-gite-drome) et [résidences secondaires](/conciergerie-residence-secondaire-drome-ardeche) sont particulièrement adaptés à notre positionnement en Drôme-Ardèche." },
...
const faqsEN = [
  ...
  { q: "Do you only work with high-end properties?", a: "No. Qit Concierge supports properties well suited to short-term rental: country houses, gîtes in Drôme and Ardèche, apartments, second homes and well-located holiday properties." },
  ...
  { q: "Do you manage houses and gîtes?", a: "Yes. Country houses, gîtes and second homes fit our Drôme-Ardèche positioning particularly well, especially when they're well equipped and in a tourist or pass-through area." },
