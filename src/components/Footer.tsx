      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
            <Link to="/services" className="hover:text-white transition-colors">{isFR ? "Services" : "Services"}</Link>
            <Link to="/methode" className="hover:text-white transition-colors">{isFR ? "Méthode" : "Approach"}</Link>
            <Link to="/tarifs" className="hover:text-white transition-colors">{isFR ? "Tarifs" : "Pricing"}</Link>
