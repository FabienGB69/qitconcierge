        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-qit-coral">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-qit-coral">Liens utiles</h3>
            <ul className="space-y-2">
              <li><a href="#services" className="text-gray-400 hover:text-white">Services</a></li>
              <li><a href="#properties" className="text-gray-400 hover:text-white">Propriétés</a></li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-qit-coral">Newsletter</h3>
            <p className="mb-4 text-gray-400">
              Abonnez-vous à notre newsletter pour recevoir nos actualités et offres spéciales.
            </p>
            <div className="flex space-x-2">
              ...
              />
              <Button className="bg-qit-coral hover:bg-qit-coral/90">OK</Button>
            </div>
          </div>
        </div>
