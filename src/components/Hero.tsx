...
const Hero = () => {
  ...
  const c = isFR
    ? {
        ...
        h1b: "maisons de campagne, appartements et résidences secondaires",
        sub: "Qit Concierge accompagne les propriétaires en Drôme-Ardèche dans la gestion complète de leur location courte durée : maisons, appartements, gîtes, résidences secondaires. Airbnb, Booking, Abritel, ménage, linge, voyageurs, calendrier et optimisation des revenus avec PriceLabs.",
    ...
    : {
        ...
        h1b: "country homes, apartments and second homes",
        sub: "Qit Concierge helps property owners in Drôme-Ardèche fully manage their short-term rental: houses, apartments, gîtes, second homes. Airbnb, Booking, Abritel, cleaning, linen, guests, calendar and revenue optimisation with PriceLabs.",
