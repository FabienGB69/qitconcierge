...
const internalLinksEN: { href: string; label: string }[] = [
  ...
  { href: "/gestion-gite-drome", label: "Gîte management — Drôme" },
  { href: "/gestion-gite-ardeche", label: "Gîte management — Ardèche" },
...
const LocalSEO = () => {
  ...
  const t = isFR
    ? {
        ...
        p1: "Qit Concierge accompagne les propriétaires de maisons, gîtes, appartements et résidences secondaires situés en Drôme-Ardèche, dans un rayon d'environ 1h autour de Tain-l'Hermitage. Nous intervenons sur les secteurs de Tain-l'Hermitage, Tournon-sur-Rhône, Romans-sur-Isère, Valence, Saint-Vallier, Saint-Donat-sur-l'Herbasse, Annonay, Saint-Péray, Guilherand-Granges, Drôme des Collines, Ardèche Verte et Vallée du Rhône.",
        p2: "Conciergerie Airbnb Drôme et conciergerie Airbnb Ardèche : gestion location courte durée Drôme-Ardèche, gestion Booking Drôme, gestion Abritel Ardèche, gestion de gîte en Drôme-Ardèche, ménage, linge, accueil voyageurs et revenue management location courte durée avec PriceLabs — un accompagnement humain et terrain pensé pour les propriétaires non disponibles sur place.",
    ...
    : {
        ...
        p1: "Qit Concierge supports owners of houses, gîtes, apartments and second homes located in Drôme-Ardèche, within about a 1-hour radius of Tain-l'Hermitage. We cover Tain-l'Hermitage, Tournon-sur-Rhône, Romans-sur-Isère, Valence, Saint-Vallier, Saint-Donat-sur-l'Herbasse, Annonay, Saint-Péray, Guilherand-Granges, Drôme des Collines, Ardèche Verte and the Rhône Valley.",
        p2: "Airbnb concierge in Drôme and Ardèche: short-term rental management, Booking and Abritel management, gîte management, cleaning, linen, guest welcome and short-term rental revenue management with PriceLabs — a hands-on, local service designed for owners who can't be on site.",
        h3a: "Areas covered",
