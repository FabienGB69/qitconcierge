...
const columns = [
  {
    ...
    items: [
      ...
      "Conseils photos et description",
      "Mise en avant des points forts",
      "Paramétrage Airbnb / Booking",
    ],
  },
  {
    icon: Settings,
    ...
    items: [
      ...
      "Check-in et instructions d'arrivée",
    ...
    <section id="services" className="py-14 md:py-28 bg-accent">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {columns.map((col, idx) => {
            ...
            return (
              <div
                key={idx}
                className="rounded-2xl bg-white border border-border p-7 md:p-8 hover:shadow-md transition-shadow flex flex-col"
              >
                ...
                <h3 className="text-xl font-bold text-qit-purple mb-5 leading-snug">
                  {col.title}
                </h3>
        ...
        <div className="flex justify-center mt-12">
          ...
          >
            <a href="#contact">
              Recevoir une proposition de gestion
