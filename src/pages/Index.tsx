...
const Index = () => {
  ...
  useSEO({
    ...
    description: isFR
      ? "Conciergerie courte durée en Drôme-Ardèche : gestion Airbnb, Booking et Abritel, ménage, linge, accueil voyageurs et optimisation PriceLabs. 25% TTC, sans abonnement."
